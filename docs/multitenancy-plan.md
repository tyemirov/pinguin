...
- Keep authenticated SMTP submission independent from notification tenants; sender identities, allowed sender domains, delivery mode, optional upstream relay profile, and public Gmail-facing settings live under `smtpSubmission`.
